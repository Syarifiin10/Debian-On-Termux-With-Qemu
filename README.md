...
**CLICK [HERE](https://play.google.com/store/apps/details?id=com.termux) TO VIEW LICENSE**ions to run Debian using QEMU on an Android device via the Termux environment.
